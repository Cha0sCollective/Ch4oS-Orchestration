...
Read the project's `AGENTS.md` and `docs/CURRENT_WORK.md`. Verify repository,
branch, HEAD, dirty files and linked work before continuing. Reconcile stale
pointers against authoritative packets/issues; surface missing authorization or
competing assignments. Load further references only as needed.
...
At packet boundaries and before ending a session, replace obsolete content in
`CURRENT_WORK.md`; keep it under roughly 500 words. Link detailed history and
evidence at their authoritative locations.
